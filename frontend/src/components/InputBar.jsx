...
export default function InputBar({ busy, disabled, onSend, onPdfQuery }) {
  ...
  return (
    <div className={s.floor}>
      <div className={[s.frame, (busy || disabled) ? s.inactive : ''].join(' ')}>
        <AttachButton
      ...
      <div className={s.meta}>
        <span className={s.hint}>↵ Submit · ⇧↵ Newline</span>
      </div>
    </div>
  )
}
